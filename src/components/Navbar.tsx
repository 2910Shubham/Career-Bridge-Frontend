...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const onStorage = () => {
      // The user state is now managed by useAuth, so no need to update it here
      // unless you want to force a re-render or update the context directly.
      // For now, we'll rely on useAuth's effect to update the context.
    };
              ...
              <div className="relative profile-dropdown">
                ...
                >
                  <Avatar className="h-8 w-8 cursor-pointer hover:opacity-80 transition-opacity">
                    <AvatarImage src={user.profilePicture || "/placeholder-avatar.jpg"} alt="Profile" />

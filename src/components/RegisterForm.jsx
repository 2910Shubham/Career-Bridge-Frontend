...
const RegisterForm = () => {
  ...
  const validateForm = () => {
    ...
    else if (!/^[0-9+\-\s()]+$/.test(formData.contact)) newErrors.contact = 'Please enter a valid phone number';
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-all duration-200 ${
                    errors.name ? 'border-red-300 focus:border-red-400' : 'border-gray-200 focus:border-opacity-80'
                  }`}
                  style={{ 
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:outline-none transition-all duration-200 ${
                    errors.contact ? 'border-red-300 focus:border-red-400' : 'border-gray-200'
                  }`}
                  placeholder="Enter your contact number"
                  onFocus={(e) => e.target.style.borderColor = '#5A827E'}
                  onBlur={(e) => e.target.style.borderColor = errors.contact ? '#fca5a5' : '#e5e7eb'}
                />
              </div>
